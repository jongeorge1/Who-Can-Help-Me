...
<asp:PlaceHolder ID="plhNew" runat="server" Visible='<%# CreatingNew %>'>
	<asp:HyperLink Enabled="false" ID="hlNew" runat="server" CssClass="command" NavigateUrl='<%# "~/Edit/Globalization/Default.aspx?selected=" + Server.UrlEncode(SelectedItem.Path) %>' ToolTip="<%# CurrentLanguage.LanguageCode %>">
